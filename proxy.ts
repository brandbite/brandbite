...
const PUBLIC_PATHS = [
  ...
  // save/list endpoint is deliberately NOT listed, so the proxy gates it
  // behind a session cookie.
  "/colors",
  // Public CMS reads for the color tools (published content only; admin
  // mutations live behind /api/admin/*).
  "/api/palette-ideas",
  "/api/color-meanings",
