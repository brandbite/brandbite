...
export default function ColorWheelPage() {
  ...
  return (
    <ColorToolShell
      currentHref="/colors/color-wheel"
      title={"Spin the wheel,"}
      accent="nail the vibe."
      blurb="Drag the handle, type a hex, or pick a color — then choose a harmony to build a palette. Arrow keys nudge hue and saturation; the slider sets lightness."
    >
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className={`w-full rounded-lg border bg-[var(--bb-bg-page)] py-2 pr-3 pl-6 font-mono text-sm tracking-wide text-[var(--bb-secondary)] uppercase outline-none focus:border-[var(--bb-primary)] ${
                  hexValid ? "border-[var(--bb-border-input)]" : "border-[var(--bb-danger-border)]"
                }`}
              />
            </div>
