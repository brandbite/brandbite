// -----------------------------------------------------------------------------
// @file: app/designer/error.tsx
// @purpose: Error boundary for designer pages (nav provided by layout)
// -----------------------------------------------------------------------------
...
export default function DesignerError({
  ...
  useEffect(() => {
    console.error("[designer] Unhandled error:", error);
  }, [error]);
  ...
  return (
    <div className="mx-auto max-w-md rounded-2xl border border-red-200 bg-white px-6 py-8 text-center shadow-sm">
      ...
      <div className="mt-4 flex items-center justify-center gap-3">
        ...
        <button
          onClick={() => (window.location.href = "/designer/board")}
