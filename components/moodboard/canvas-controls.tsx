...
export function CanvasControls({
  ...
  return (
    <div className="fixed right-8 bottom-4 z-50 flex items-center gap-1 rounded-xl border border-[var(--bb-border-subtle)] bg-white/90 px-1 py-1 shadow-[0_2px_8px_rgba(0,0,0,0.08),0_1px_2px_rgba(0,0,0,0.04)] backdrop-blur-sm">
      <button
        onClick={onZoomOut}
