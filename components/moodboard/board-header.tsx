      ...
      <div className="flex-1 px-4 text-center min-w-0">
        {editing ? (
          <input
            ...
            className="w-full max-w-md mx-auto rounded-lg border border-[var(--bb-primary)] bg-white px-3 py-1.5 text-center text-sm font-semibold text-[var(--bb-secondary)] outline-none"
          />
        ) : (
          <button
            type="button"
