    ...
    <Modal open={open} onClose={handleClose} size="md">
      ...
      <div className="space-y-3">
        ...
        <textarea
          ...
          rows={5}
          className="w-full resize-none rounded-lg border border-[var(--bb-border)] bg-white px-3 py-2 text-sm text-[var(--bb-secondary)] outline-none placeholder:text-gray-400 focus:border-[var(--bb-primary)]"
        />
      </div>
