...
const VARIANT_CLASSES: Record<BadgeVariant, string> = {
  neutral:
    "bg-[var(--bb-bg-card)] text-[var(--bb-text-tertiary)] border border-[var(--bb-border-input)]",
  primary:
  ...
  success:
    "bg-[var(--bb-success-bg)] text-[var(--bb-success-text)] border border-[var(--bb-success-border)]",
  warning:
    "bg-[var(--bb-warning-bg)] text-[var(--bb-warning-text)] border border-[var(--bb-warning-border)]",
  danger:
    "bg-[var(--bb-danger-bg)] text-[var(--bb-danger-text)] border border-[var(--bb-danger-border)]",
};
